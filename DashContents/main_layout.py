...
from DashContents.main_components import make_dash_table, print_button
...
def get_menu():
    menu = html.Div([
        dcc.Link('Geral         ', href='/overview', className="tab first"),
        dcc.Link(u'Socioeconômia        ',
                 href='/price-performance', className="tab"),
        dcc.Link('Serviços          ',
                 href='/portfolio-management', className="tab"),
        dcc.Link('Comércio         ', href='/fees', className="tab"),
        dcc.Link('Indústria         ', href='/fees', className="tab"),
        dcc.Link('Saúde         ', href='/fees', className="tab"),
                    ...
                    figure={
                        'data': [
                            go.Scatter(
                                ...
                                y=["10000", "7500", "9000", "10000", "10500", "11000",
                                   "14000", "18000", "19000", "20500", "24000"],
...
pricePerformance = html.Div([  # page 2
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.H6(["Average annual returns--updated monthly as of 02/28/2018"],
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Li(
                    "Vanguard Quantitative Equity Group, the fund's advisor, is among the world's largest equity index managers."),
                html.Br([]),
